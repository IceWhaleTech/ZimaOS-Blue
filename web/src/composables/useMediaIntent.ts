...
const allLangKeywords: Record<string, LangKeywords> = {
  en: {
    ...
    editVerbs: ['edit', 'change', 'modify', 'transform', 'alter', 'adjust', 'fix', 'retouch', 'enhance', 'upscale', 'remove', 'replace', 'restyle'],
  ...
  zh: {
    ...
    editVerbs: ['编辑', '修改', '改', '变', '调整', '修复', '美化', '去除', '替换', '换'],
  ...
  ja: {
    ...
    editVerbs: ['編集', '変更', '修正', '加工', '調整', '変えて', '直して'],

...
<template>
  <div class="p-6 max-w-6xl mx-auto">
    ...
    >
      <svg
        class="animate-spin h-8 w-8 text-gray-900 dark:text-gray-300"
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
      >
    ...
    <div
      ...
      class="bg-white dark:bg-gray-700 rounded-xl shadow overflow-hidden"
    >
      <table class="w-full">
          ...
          >
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="flex items-center">
                <div
                  class="h-10 w-10 rounded-full bg-gray-200 dark:bg-gray-600/20 flex items-center justify-center"
                >
    ...
    <div
      v-else
      class="text-center py-12 bg-white dark:bg-gray-700 rounded-xl"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"

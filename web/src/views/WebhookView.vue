...
<template>
  <div class="webhook-view p-4 sm:p-6 max-w-6xl mx-auto">
    ...
    <div v-else class="space-y-4">
      <div v-for="webhook in webhooks" :key="webhook.id" class="glass-card p-4">
        <div class="flex items-start justify-between">
          <div class="flex-1 min-w-0">
            <div class="flex items-center gap-3 mb-2">
              ...
              <span
                class="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 rounded-full text-xs font-medium"
              >
                {{ webhook.type }}
              </span>
            </div>
            ...
            <div class="flex items-center gap-2 text-xs">
              <code
                class="bg-gray-100 dark:bg-slate-700 px-2 py-1 rounded text-gray-600 dark:text-gray-300 truncate max-w-md"
              >
      ...
      <div class="bg-white dark:bg-slate-800 rounded-lg max-w-md w-full shadow-xl">
        <div class="p-4 sm:p-6">
          ...
          <div class="flex items-center gap-2 mb-4">
            <code
              class="flex-1 bg-gray-100 dark:bg-slate-700 px-3 py-2 rounded text-sm text-gray-900 dark:text-white break-all"
            >
              {{ newSecret }}
            </code>
            <button
    ...
    >
      <div
        class="bg-white dark:bg-slate-800 rounded-lg max-w-2xl w-full max-h-[80vh] overflow-hidden shadow-xl"
      >
        ...
        <div class="p-4 sm:p-6 overflow-y-auto max-h-[60vh]">
          ...
          <div v-else class="space-y-3">
            <div v-for="event in events" :key="event.id" class="glass-card p-3">
              <div class="flex items-center justify-between mb-2">
                <div class="flex items-center gap-2">
                  <span
                    class="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 rounded text-xs font-medium"
                  >
                    {{ event.method }}
                  </span>

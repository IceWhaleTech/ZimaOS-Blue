...
<template>
  <div class="audit-view p-4 sm:p-6 max-w-6xl mx-auto">
    ...
    <div v-if="stats" class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
      ...
      <div class="glass-card p-4">
        <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ stats.by_action.login || 0 }}</div>
    ...
    <div class="glass-card p-4 mb-6">
      <div class="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div class="flex gap-2">
          <button
            class="flex-1 px-4 py-2 bg-accent hover:bg-accent-hover text-white rounded-lg text-sm transition-colors"
            @click="applyFilters"
          >
            {{ t('audit.filter') }}
          </button>

  ...
  <div class="autoreply-view p-6 max-w-6xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <button
          class="px-4 py-2 bg-gray-800 dark:bg-gray-500 hover:bg-gray-700 dark:hover:bg-gray-400 text-white rounded-lg text-sm transition-colors flex items-center gap-2"
    ...
    <div v-else class="bg-white dark:bg-gray-700 rounded-lg p-12 text-center shadow">
      ...
      <button
        ...
        class="px-4 py-2 bg-gray-800 dark:bg-gray-500 hover:bg-gray-700 dark:hover:bg-gray-400 text-white rounded-lg transition-colors"
        @click="openCreateModal"
      >
        {{ t('autoReply.createRule') }}
      </button>

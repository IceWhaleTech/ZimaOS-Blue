...
async function loadEvalRunReport(runID: string, options: { silent?: boolean } = {}) {
  ...
  try {
    ...
    notification.error(tr('nav.harness', 'Harness'), getErrorMessage(err))
  } finally {
                ...
                <div class="report-grid">
                  ...
                  <article class="detail-card detail-card-wide report-outcome-card">
                    <div class="detail-card-header">
                      <div>
                        <h3>{{ tr('harness.groups.title', 'Group outcome') }}</h3>
                        <p class="card-copy">
                          {{
                            tr(
        ...
        <section class="panel groups-panel">
          <div class="section-header">
            <div>
              ...
              <h2>{{ tr('nav.harness', 'Harness') }} {{ tr('harness.groups.title', 'groups') }}</h2>
              <p class="section-description">
                {{
                  tr(

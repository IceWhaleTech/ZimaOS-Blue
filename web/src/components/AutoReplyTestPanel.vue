...
<template>
  <div class="space-y-4">
    ...
    <!-- Test Button -->
    <button
      class="w-full px-4 py-2 bg-gray-800 dark:bg-gray-500 hover:bg-gray-700 dark:hover:bg-gray-400 text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"

        ...
        <div class="w-full max-w-lg mx-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-2xl overflow-hidden">
          ...
          <div class="px-5 py-4 space-y-3">
            <div v-if="approval.directory" class="space-y-1">
              <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('execApproval.directory') }}</p>
              <code class="block text-sm px-3 py-2 rounded-md bg-gray-100 dark:bg-gray-900 text-red-600 dark:text-red-400 break-all">{{ approval.directory }}</code>
            </div>

...
<template>
  <div class="code-card rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden bg-gray-50 dark:bg-gray-900">
    <!-- Header -->
    ...
    <div class="overflow-x-auto">
      <pre class="p-4 text-sm leading-relaxed"><code class="text-gray-800 dark:text-gray-100"><template v-for="(line, index) in highlightedLines" :key="index"><span

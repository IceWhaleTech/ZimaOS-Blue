...
import type { TypelessCardInfo } from '@/types/typeless'

defineProps<{
  card: TypelessCardInfo
}>()

const variantClasses = {
  default:
    'bg-gray-700 dark:bg-gray-500/20 border-gray-900 dark:border-white dark:border-gray-900 dark:border-white',
  ...
  <div class="rounded-lg border p-4" :class="variantClasses[card.variant || 'default']">
    <div class="flex items-start gap-3">
      <span
        ...
        :class="iconClasses[card.variant || 'default']"
      >
        {{ card.icon }}
      </span>

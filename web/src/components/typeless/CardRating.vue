  ...
  <div class="rating-card rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-800">
    ...
    <div class="p-4">
      ...
      <div class="flex items-center gap-6">
        ...
        <!-- Breakdown bars -->
        <div v-if="card.breakdown?.length" class="flex-1 space-y-2">
          <div v-for="item in card.breakdown" :key="item.stars" class="flex items-center gap-2">
      ...
      <!-- Featured review -->
      <div v-if="card.review" class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">

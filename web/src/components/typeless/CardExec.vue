...
<template>
  <div class="exec-card">
    <div class="exec-card__header">
      ...
      <span v-else class="exec-card__command exec-card__command--muted">{{
        t('execCard.commandHidden', 'Command hidden')
      }}</span>
    ...
    <div v-if="hasWarnings" class="exec-card__warnings">
      <div class="exec-card__warnings-header">
    ...
    <button v-if="shouldCollapse" class="exec-card__toggle" @click="expanded = !expanded">

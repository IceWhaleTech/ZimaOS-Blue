...
<template>
  <div class="search-card rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
    ...
    <div class="flex items-center gap-2 px-4 py-3 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
      <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-500 dark:text-gray-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <span class="text-xs text-gray-400 dark:text-gray-500 flex-shrink-0">
        {{ t('search.resultCount', { count: (props.card.results ?? []).length }) }}
      </span>
    </div>
    ...
    <div class="divide-y divide-gray-100 dark:divide-gray-700">
      <a
        ...
        class="block px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset"
      >

...
async function saveRetentionSettings() {
  try {
    ...
    emit('status-change', t('userdata.retentionSaved'))
  } catch (e) {
  ...
  <div class="space-y-4">
    ...
    <div v-show="activeTab === 'export'" class="glass-card p-4">
      ...
      <button
        ...
        class="w-full px-4 py-2 bg-accent hover:bg-accent-hover text-white rounded-lg text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        @click="handleExport"
      >
    ...
    <div v-show="activeTab === 'import'" class="glass-card p-4">
      ...
      <div class="flex gap-2">
        ...
        <button
          ...
          class="flex-1 px-4 py-2 bg-accent hover:bg-accent-hover text-white rounded-lg text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          @click="handleImport"
        >
        ...
        <div class="relative bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-md w-full max-h-[80vh] overflow-y-auto">
          ...
          <div class="p-4 space-y-4">
            ...
            <button
              ...
              class="w-full px-4 py-2 bg-accent hover:bg-accent-hover text-white rounded-lg text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
                <div class="flex items-start gap-2">
                  ...
                  <div class="text-sm text-blue-700 dark:text-blue-300">
                    ...
                    <p class="mt-1 text-blue-600 dark:text-blue-400">{{ t('userdata.cleanup.authorizationHint') }}</p>
                  </div>
                </div>
              </div>

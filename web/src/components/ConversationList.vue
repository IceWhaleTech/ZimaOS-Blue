...
<template>
  <div class="conversation-list h-full flex flex-col bg-gray-900">
    <!-- Header -->
    ...
    <div class="p-4 border-b border-gray-700">
      <div class="relative">
        <input
          ...
          class="w-full bg-gray-800 text-white rounded-lg px-4 py-2 pl-10 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="flex-1 overflow-y-auto">
      ...
      <div v-else class="divide-y divide-gray-800">
        <div
          ...
          :class="{ 'bg-gray-800': conversation.id === currentId }"
        >
          <button
            class="w-full p-4 text-left hover:bg-gray-800/50 transition-colors"
          ...
          <div
            ...
            class="absolute inset-0 bg-gray-900/95 flex items-center justify-center gap-2 p-2"
          >

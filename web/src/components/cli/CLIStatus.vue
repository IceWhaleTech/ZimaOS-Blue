      ...
      <div class="flex items-center gap-3">
        ...
        <div
          :class="[
            ...
            statusColor === 'green' ? 'bg-green-100 dark:bg-green-800/50 text-green-600 dark:text-green-400' :
            statusColor === 'yellow' ? 'bg-yellow-100 dark:bg-yellow-800/50 text-yellow-600 dark:text-yellow-400' :
            'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400'
          ]"
        >
          <svg v-if="statusIcon === 'installed'" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
          </svg>
          <svg v-else-if="statusIcon === 'not-installed'" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">

  ...
  <section class="mb-6 sm:mb-8" id="claude-code-settings">
    ...
    <div class="glass-card">
      ...
      <div v-else-if="versionInfo">
        ...
        <div v-if="!isEnabled" class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-4 mb-4">
          <div class="flex items-start gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-600 dark:text-blue-300 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">

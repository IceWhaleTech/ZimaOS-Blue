...
declare global {
  ...
  // @ts-ignore
  export type { ToolResultItem, StreamUIPhase, StreamUIState, ActiveMessageStreamState, PendingModelAutoFallback, PendingProviderFailoverRetry } from './stores/chat'
  import('./stores/chat')
  // @ts-ignore

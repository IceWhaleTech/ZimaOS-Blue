...
const requiredPaths = [
  ...
  'chat.processTrace.events.providerResolved',
  'chat.processTrace.events.processing',
  'chat.processTrace.details.requestDispatched',
  'chat.processTrace.details.waitingForResponse',
  'chat.processTrace.details.providerResolved',
  'chat.processTrace.details.providerResolvedModelSwitch',
  'chat.processTrace.details.providerResolvedFailoverSwitch',
  'chat.processTrace.details.providerFailoverToolFollowUp',
  'chat.processTrace.details.providerFailoverContinuationFollowUp',

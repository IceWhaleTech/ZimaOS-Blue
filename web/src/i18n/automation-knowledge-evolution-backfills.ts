...
const automationKnowledgeEvolutionBackfills: Partial<Record<LocaleKey, object>> = {
  'en-US': {
    ...
    knowledge: {
      ...
      repairConflicts: 'Repair conflicts',
      repairConflictsStarted: 'Knowledge conflict repair started.',
      repairConflictsComplete: 'Knowledge conflicts repaired.',
      mapTitle: 'Knowledge map',
      graphNodeCount: '{count} nodes',
      graphEdgeCount: '{count} links',
      graphLegendReference: 'Reference',
      graphLegendConflict: 'Conflict',
      graphLegendSuperseded: 'Superseded',
      graphEmpty: 'No visible pages yet. Run ingest or relax your filters to grow the graph.',
      graphFocus: 'Focus',
      graphZoomIn: 'Zoom in',
      graphZoomOut: 'Zoom out',
      graphReset: 'Reset',
      graphPanHint: 'Drag to pan. Use the wheel or buttons to zoom.',
      graphLayer: 'Layer',
      graphLayerIdle: 'Click a node to focus. Zoom to peel back outer layers.',
      graphLayerNear: 'Focus with direct neighbors',
      graphLayerMid: 'Second-hop context',
      graphLayerFar: 'Extended orbit',
      graphLayerFull: 'Outer background and detached knowledge',
      graphTooltipLinks: '{count} links',
      queryTitle: 'Query',
    ...
    evolution: {
      ...
      lanes: {
        ...
        skillsDescription: 'Review canonical skills, accepted revisions, and rollback readiness.',
        runnerDescription: 'Inspect runner candidates, execution evidence, and switch boundaries.',
  ...
  'zh-CN': {
    ...
    knowledge: {
      ...
      description:
        '将本地来源整理成持久知识 wiki，并在结构定义、活动日志、冲突与查询沉淀之间持续演化。',
      pageList: '编译页面',
      ...
      lintStarted: '知识检查已开始。',
      repairConflictsStarted: '知识冲突修复已开始。',
      never: '从未',
      mapTitle: '知识地图',
      mapHint: '按类型浏览持久页面，跨来源与摘要搜索，并检查证据状态。',
      graphNodeCount: '{count} 个节点',
      graphEdgeCount: '{count} 条连线',
      graphLegendReference: '关联',
      graphLegendConflict: '冲突',
      graphLegendSuperseded: '已替代',
      graphEmpty: '当前还没有可显示的页面。先运行摄入，或放宽筛选条件来生成图谱。',
      graphFocus: '当前焦点',
      graphZoomIn: '放大',
      graphZoomOut: '缩小',
      graphReset: '重置',
      graphPanHint: '拖动画布可平移，也可以使用滚轮或按钮缩放。',
      graphLayer: '层级',
      graphLayerIdle: '点击一个节点聚焦，然后通过缩放逐层展开外圈。',
      graphLayerNear: '焦点与直接邻居',
      graphLayerMid: '二跳上下文',
      graphLayerFar: '扩展轨道层',
      graphLayerFull: '外层背景与游离知识',
      graphTooltipLinks: '{count} 条连接',
      queryTitle: '查询',
  ...
  'zh-TW': {
    ...
    knowledge: {
      ...
      lintStarted: '知識檢查已開始。',
      repairConflictsStarted: '知識衝突修復已開始。',
      never: '從未',
      mapTitle: '知識地圖',
      mapHint: '按類型瀏覽持久頁面，跨來源與摘要搜尋，並檢查證據狀態。',
      graphNodeCount: '{count} 個節點',
      graphEdgeCount: '{count} 條連線',
      graphLegendReference: '關聯',
      graphLegendConflict: '衝突',
      graphLegendSuperseded: '已取代',
      graphEmpty: '目前還沒有可顯示的頁面。先執行攝入，或放寬篩選條件來生成圖譜。',
      graphFocus: '目前焦點',
      graphZoomIn: '放大',
      graphZoomOut: '縮小',
      graphReset: '重設',
      graphPanHint: '拖動畫布可平移，也可以使用滾輪或按鈕縮放。',
      graphTooltipLinks: '{count} 條連線',
      queryTitle: '查詢',
  ...
  'ja-JP': {
    ...
    evolution: {
      title: '自己修復と進化のコンソール',
      subtitle: '証拠と安全な承認にもとづいて、スキル、Runner 変更、指示提案を確認します。',
      tabs: {
        knowledge: 'ナレッジ',
        skills: 'スキル',
        runner: 'Runner',
  ...
  'de-DE': {
    ...
    evolution: {
      ...
      lanes: {
        ...
        runnerDescription: 'Prüfen Sie Runner-Kandidaten, Ausführungsbelege und Umschaltgrenzen.',
        instructionsDescription:
  ...
  'pt-BR': {
    ...
    evolution: {
      ...
      lanes: {
        ...
        skillsDescription: 'Revise skills canônicas, revisões aceitas e prontidão para rollback.',
        runnerDescription:
  ...
  'pt-PT': {
    ...
    evolution: {
      ...
      lanes: {
        ...
        skillsDescription: 'Reveja skills canónicas, revisões aceites e preparação para rollback.',
        runnerDescription:
  ...
  'nl-NL': {
    ...
    evolution: {
      ...
      lanes: {
        ...
        runnerDescription: 'Inspecteer runner-kandidaten, uitvoeringsbewijs en schakelgrenzen.',
        instructionsDescription:
  ...
  'pl-PL': {
    ...
    evolution: {
      ...
      lanes: {
        ...
        runnerDescription: 'Sprawdzaj kandydatów runnera, dowody wykonania i granice przełączenia.',
        instructionsDescription:
  ...
  'sv-SE': {
    ...
    knowledge: {
      ...
      description: 'Granska kompilerade kunskapssidor, kör underhåll och ställ välgrundade frågor.',
      pageListHint: 'Välj en sida för att granska källor, relaterade sidor och arkiverade svar.',
    ...
    evolution: {
      ...
      lanes: {
        ...
        runnerDescription: 'Granska runner-kandidater, körningsbevis och växlingsgränser.',
        instructionsDescription:
  ...
  'nb-NO': {
    ...
    knowledge: {
      ...
      pageListHint: 'Velg en side for å inspisere kilder, relaterte sider og arkiverte svar.',
    ...
    evolution: {
      ...
      lanes: {
        ...
        runnerDescription: 'Inspiser runner-kandidater, kjørselsbevis og byttegrenser.',
        instructionsDescription:
  ...
  'da-DK': {
    ...
    knowledge: {
      ...
      pageListHint: 'Vælg en side for at undersøge kilder, relaterede sider og arkiverede svar.',
    ...
    evolution: {
      ...
      lanes: {
        ...
        runnerDescription: 'Undersøg runner-kandidater, udførelsesevidens og skiftegrænser.',
        instructionsDescription:
  ...
  'cs-CZ': {
    ...
    evolution: {
      ...
      lanes: {
        ...
        runnerDescription: 'Prověřujte kandidáty runneru, důkazy z běhu a hranice přepnutí.',
        instructionsDescription:
  ...
  'sk-SK': {
    ...
    evolution: {
      ...
      lanes: {
        ...
        runnerDescription: 'Skontrolujte kandidátov runnera, dôkazy z behu a hranice prepnutia.',
        instructionsDescription:
  ...
  'hu-HU': {
    automation: {
      tabs: {
        knowledge: 'Tudás',
        knowledgeDesc:
          'Böngéssze az összeállított oldalakat, a lint állapotát és a megalapozott válaszokat.',
        evolution: 'Evolúció',
  ...
  'el-GR': {
    automation: {
      tabs: {
        knowledge: 'Γνώση',
        knowledgeDesc:
          'Περιηγηθείτε σε μεταγλωττισμένες σελίδες, κατάσταση lint και τεκμηριωμένες απαντήσεις.',
        evolution: 'Εξέλιξη',
  ...
  'ml-IN': {
    automation: {
      tabs: {
        knowledge: 'ജ്ഞാനം',
        knowledgeDesc:
          'കമ്പൈൽ ചെയ്ത പേജുകൾ, lint നില, അടിസ്ഥാനമുള്ള ഉത്തരങ്ങൾ എന്നിവ ബ്രൗസ് ചെയ്യുക.',
        evolution: 'പരിണാമം',

...
export default {
  ...
  browserMonitor: browserMonitorLocales['sv-SE'],
  theme: {
    styles: {
      title: 'Temastil',
      default: 'Standard',
  ...
  settings: {
    ...
    network: {
      ...
      confirmRemoveDynamicOrigin:
        'Ta bort dynamiskt origin "{origin}"? Detta kan påverka aktiva tunnel-callbacks.',
    ...
    smallModel: {
      ...
      advancedHint: 'Justera endast for felsokning eller validering av kontrollerad rollout.',
      expand: 'Expandera',
      collapse: 'Fall ihop',
      ...
      shadowRatio: 'Andel bakgrundsvalidering',
      ...
      contextCompressionModeAuto:
        'Auto: föredra komprimering med liten modell, med fallback till offline',
      contextCompressionModeSmallModel: 'Liten modell först',
      ...
      statsTitle: 'Kortidsstatistik (felsokning)',
      statsHint: 'Framst for felsokning och tuning; kan ignoreras i daglig anvandning.',
  ...
  billing: {
    ...
    drilldownTitle: 'Uppdelning av toppens kalla',
    drilldownHint: 'Visar storsta bidragsgivare for vald anomalidag.',
    drilldownLoading: 'Analyserar toppkallor...',
    drilldownProvider: 'Toppleverantorer',
  ...
  security: {
    ...
    tabDescriptions: {
      ...
      controls: 'Hantera betrodda kataloger, skyddsräcken för promptar och maskeringspolicyer.',
      network: 'Hantera TLS/HTTPS-certifikat, CORS-ursprung och nätverksexponering.',

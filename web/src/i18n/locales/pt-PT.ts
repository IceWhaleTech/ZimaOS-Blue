...
export default {
  ...
  speech: {
    ...
    macosNativeName: 'macOS Nativo', macosNativeDesc: 'Síntese de voz macOS integrada (offline, sem transferência)', macosNativeSTTDesc: 'Reconhecimento de voz macOS integrado (offline, sem transferência)', macosNativeQuality: 'Bom',

...
export default {
  ...
  common: {
    ...
    cancel: 'Cancelar',
    delete: 'Eliminar',
    deleting: 'A eliminar...', // instead of 'Excluir'
    create: 'Criar',
    creating: 'A criar...',
    search: 'Pesquisar',
  ...
  browserMonitor: browserMonitorLocales['pt-PT'],
  theme: { ...ptBR.theme },
  brand: { ...ptBR.brand },
  errors: {
    ...ptBR.errors,
  ...
  settings: {
    ...
    smallModel: {
      ...
      contextCompressionModeAuto:
        'Automático: privilegiar compressão com modelo pequeno e, se falhar, recorrer ao modo offline',
  ...
  security: {
    ...
    tabDescriptions: {
      ...
      controls: 'Gira diretórios fidedignos, guardrails de prompts e políticas de mascaramento.',
      network: 'Gira certificados TLS/HTTPS, origens CORS e exposição de rede.',

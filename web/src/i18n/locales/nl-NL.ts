...
export default {
  ...
  onboarding: {
    ...
    previewModeDesc: 'Je kunt Echo direct gebruiken. Alle functies zijn beschikbaar en je gegevens worden opgeslagen.',
  ...
  remoteAccess: {
    ...
    description: 'Open je Echo overal via een beveiligde tunnel',
    channelDescription: 'Echo overal bereikbaar – geen botconfiguratie nodig',
    ...
    securityWarning: 'Waarschuwing: Iedereen met de link kan toegang krijgen tot je Echo',

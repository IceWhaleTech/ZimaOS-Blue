...
const harness = getHarnessLocaleOverlay('pl-PL')
...
export default {
  ...
  browserMonitor: browserMonitorLocales['pl-PL'],
  theme: {
    styles: {
      title: 'Styl motywu',
      default: 'Domyślny',
  ...
  settings: {
    ...
    smallModel: {
      ...
      contextCompressionModeAuto:
        'Automatycznie: preferuj kompresję małym modelem, z przejściem awaryjnym do trybu offline',
      contextCompressionModeSmallModel: 'Najpierw mały model',
      contextCompressionModeOffline: 'Deterministycznie offline',
  ...
  security: {
    ...
    tabDescriptions: {
      ...
      controls: 'Zarządzaj zaufanymi katalogami, zabezpieczeniami promptów i zasadami maskowania.',
      network: 'Zarządzaj certyfikatami TLS/HTTPS, źródłami CORS i ekspozycją sieci.',

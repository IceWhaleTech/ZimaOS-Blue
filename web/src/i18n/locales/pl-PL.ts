...
export default {
  ...
  chat: {
    ...
    deepResearchHoverDescription:
      'Uruchom uporządkowany proces badawczy z pobieraniem, weryfikacją i odpowiedziami opartymi na źródłach.',
  ...
  settings: {
    ...
    antigravity: {
      ...
      noModels: 'No quota information available',
        ...
        status: "Stan",
        description: "Zarządzaj lokalnymi poleceniami mostu ACP oraz zdalnymi kartami agentów A2A lub punktami końcowymi RPC.",
        newAcp: "Nowość ACP",
        newA2a: "Nowość A2A",
        availableProfiles: "Dostępne profile",
        editor: "Edytor profilu",
        newProfile: "Nowy profil",
        draftHint: "Wybierz typ połączenia, a następnie wypełnij wymagane pola poniżej.",
        requiredName: "Nadaj profilowi nazwę",
        requiredAcpRoute: "Dodaj polecenie lokalne Blue, które powinno zostać uruchomione",
        requiredA2aRoute: "Dodaj punkt końcowy lub kartę agenta URL",
        requiredChecks: "Przeprowadź weryfikację i kontrolę stanu przed użyciem go na czacie",
        saveThenCheck: "Najpierw zapisz, a następnie uruchom weryfikację i kontrolę stanu",
        acpPlainTitle: "Narzędzia lokalne (ACP)",
        a2aPlainTitle: "Zdalni agenci (A2A)",
        acpOverview: "Uruchom lokalną komendę CLI lub most na tym komputerze.",
        a2aOverview: "Zadzwoń do karty zdalnego agenta lub punktu końcowego RPC przez sieć.",
        acpListHelp: "Użyj ACP, gdy Blue powinien uruchomić lokalny adapter lub kodowanie CLI na tym urządzeniu.",
        a2aListHelp: "Użyj A2A, gdy Blue powinien wywołać usługę zdalną za pomocą punktu końcowego lub karty agenta URL.",
        acpSetupHelp: "Blue uruchomi to polecenie lokalnie, gdy potrzebny będzie adapter ACP.",
        a2aSetupHelp: "Blue połączy się z tym zdalnym agentem za pośrednictwem HTTP przy użyciu punktu końcowego lub karty URL.",
        duplicateReady: "Skopiowano do nowej, edytowalnej wersji roboczej.",
        ...
        health: "Zdrowie",
        verify: "Zweryfikuj",
        pendingSetup: "Oczekuje na konfigurację",
        endpointAndCard: "Punkt końcowy + karta",
        commandConfigured: "Polecenie skonfigurowane",
        cwd: "Katalog roboczy",
        environment: "Zastąpienia środowiska",
        acpRouteHint: "Dodaj polecenie i argumenty Blue powinny zostać uruchomione lokalnie.",
        endpoint: "Punkt końcowy URL",
        cardUrl: "Karta Agenta URL",
        headers: "Nagłówki żądań",
        a2aRouteHint: "Dodaj zdalny punkt końcowy lub kartę agenta, którą Blue powinien wywołać.",
        ...
        duplicate: "Duplikat",
        builtinHelp: "Wbudowane profile pozostają tylko do odczytu, więc początkowe wpisy Claude, Codex, Gemini i ogólne A2A pozostają stabilne.",
        connectionType: "Typ połączenia",
        route: "Trasa",
        basicInfo: "Podstawowe informacje",
        basicInfoHelp: "Użyj jasnej nazwy i krótkiego opisu, aby profil był łatwy do późniejszego zauważenia.",
        connectionDetails: "Szczegóły połączenia",
        acpConnectionHelp: "Powiedz Blue, jakie polecenie lokalne powinien uruchomić, plus wszelkie zastąpienia katalogu roboczego lub env.",
        a2aConnectionHelp: "Powiedz Blue, który zdalny punkt końcowy lub kartę agenta powinien wywołać.",
        command: "Polecenie i argumenty",
        commandHint: "Wbudowane profile ACP korzystają z programów uruchamiających mosty opartych na npx, dzięki czemu Blue może uruchomić adapter bez konieczności zakładania oddzielnie zainstalowanego pliku binarnego.",
        accessControl: "Poświadczenia i routing",
        accessControlHelp: "Wypełniaj te pola tylko wtedy, gdy cel wymaga uwierzytelnienia, okablowania dostawcy lub dodatkowych nagłówków.",
        credentialSource: "Źródło danych uwierzytelniających",
        authMethod: "Metoda autoryzacji",
        advancedOptions: "Zaawansowane opcje",
        advancedOptionsHelp: "IDs i surowe metadane są zwykle potrzebne tylko do importu lub automatyzacji.",
        metadata: "Metadane",
        errors: {
  ...
  providerPool: {
    ...
    customCompatibleProviderHint: 'Używaj własnego kompatybilnego endpointu i zachowaj obsługę dynamicznej weryfikacji/sondowania.',

...
export default {
  ...
  providerPool: {
    ...
    providers: {
      ...
      minimax: 'MiniMax - Modele abab do czatu i generowania treści',
    ...
    healthErrors: {
      authError: 'Uwierzytelnienie nie powiodło się (HTTP {code}) — sprawdź swój klucz API',

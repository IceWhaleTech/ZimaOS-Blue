...
export default {
  ...
  chat: {
    ...
    networkRetrying: 'Connection interrupted, retrying...',
    networkRecovering: 'Recovering response...',
  ...
  skills: {
    builtin: {
      ...
      push_notification: { name: 'Push Notification', description: 'Send push notifications and manage scheduled alerts' },
  ...
  providerPool: {
    ...
    providers: {
      ...
      minimax: 'MiniMax - abab series models for chat and content generation',
      ...
      'minimax-audio': 'MiniMax - Text-to-speech and music generation',
    },
    tabs: {
      all: 'All',
      trial: 'Trial',
  ...
  personality: {
    ...
    // Status messages
    activated: 'Personality activated successfully',
    deleted: 'Personality deleted successfully',
    empty: 'No personalities yet. Create one to get started.',
  },
  resultCard: {
    titles: {

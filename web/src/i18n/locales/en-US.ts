...
export default {
  ...
  companion: {
    ...
    // Export
    // Status (session status: active, idle, ended, error)
    status: {
      active: 'Active',
      idle: 'Idle',
      ended: 'Ended',
  ...
  speech: {
    ...
    asr: {
      ...
      description: 'Convert speech to text using local AI models',
    },
    tts: {
      title: 'Text-to-Speech (TTS)',
      description: 'Convert text to natural speech using local AI models',
    },
    prompt: {

...
export default {
  ...
  apiProxy: {
    ...
    prunerDesc: 'Smart context pruning powered by IR scoring — removes low-relevance lines while preserving key semantics, with negligible impact on output quality.',
    prunerSavings: 'Local IR saves ~47% tokens on code and ~46% on documents. swe-pruner saves 54% for programming scenarios.',

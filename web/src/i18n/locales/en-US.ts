...
export default {
  ...
  security: {
    ...
    events: {
      comingSoon: 'Security event logs coming soon',
    },
  ...
  providerPool: {
    ...
    apiFormatHint: 'Leave empty to auto-detect, or select manually if detection fails',
  ...
  speech: {
    ...
    inUse: 'In Use',
    noModels: 'No models available',
    info: 'Speech module provides local ASR (Automatic Speech Recognition) and TTS (Text-to-Speech) capabilities. Download a model to enable voice transcription.',

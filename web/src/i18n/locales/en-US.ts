...
export default {
  ...
  apiProxy: {
    ...
    cacheDesc: 'Response caching for API proxy requests, reducing latency and costs',
    ...
    routingDesc: 'Route simple tasks to cheaper models (e.g., Haiku, GPT-4o-mini) to save costs',
    routingSwitch: 'Enable Model Routing',
    routingEnabled: 'Model routing enabled',
    routingDisabled: 'Model routing disabled',
    routingRules: 'Routing Scenarios',
    routingRulesDesc: 'Toggle individual routing rules. Matched requests are routed to cheaper models.',
    routingSavings: 'Est. savings per 1K req/day',
    routingSavingsMonth: '/mo',
    routingTraffic: 'Traffic',
    routingTarget: 'Target',
    ruleSmallBody: 'Short Q&A',
    ruleSmallBodyDesc: 'Body < 3KB → Haiku (saves ~97%)',
    ruleFileTools: 'Tool Calls',
    ruleFileToolsDesc: 'file_search/grep → GPT-4o-mini (saves ~98%)',
    ruleOrchestrator: 'Complex Reasoning',
    ruleOrchestratorDesc: '[ORCHESTRATOR] tag → DeepSeek-R1 (saves ~97%)',
    ruleBackground: 'Background Tasks',
    ruleBackgroundDesc: 'Title gen/summary → downgrade to Haiku/mini (saves ~98%)',

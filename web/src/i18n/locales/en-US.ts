...
export default {
  ...
  skillStore: {
    title: 'Skill Store',
    subtitle: 'Browse, install, and manage skills',
    stats: {
      installed: 'Installed',
      enabled: 'Enabled',
      available: 'Available',
    ...
    empty: {
      ...
      noInstalledYet: 'No skills installed yet',
  ...
  taskCenter: {
    ...
    tabs: {
      ...
      workflow: 'Workflows',
      workflowDesc: 'Design and manage automation workflows',
      a2ui: 'A2UI Canvas',
      a2uiDesc: 'Build dynamic UI components with AI',
    },
    stats: {
      entities: 'Entities',
  ...
  a2ui: {
    title: 'A2UI Canvas',
    subtitle: 'Build and manage dynamic UI components with AI',
    canvas: 'Canvas',
    noCanvases: 'No Canvases',
    noCanvasesDesc: 'Canvases are created dynamically through AI interactions in chat.',
  ...
  security: {
    ...
    lastUsed: 'Last used',
    apiKeyCreated: 'API Key Created',
    apiKeyWarning: 'Make sure to copy your API key now. You won\'t be able to see it again!',
    ...
    enterPasswordToDisableMFA: 'Enter your password to disable MFA',
    ...
    sandbox: {
      ...
      description: 'Isolated execution environment for untrusted code',
      supported: 'Supported',
      ...
      noExecutions: 'No running executions',
      memory: 'Memory',
      started: 'Started',
      kill: 'Kill',
      confirmKill: 'Are you sure you want to kill this execution?',
      loadFailed: 'Failed to load sandbox information',
    },
    // Threat Detection
    threats: {
      statusSecure: 'System Secure',
      statusAtRisk: 'Security Alert',
      threatsDetected: '{count} threats detected in the last 24 hours',

...
export default {
  ...
  remoteAccess: {
    ...
    antivirusWarningDesc: 'ngrok is a legitimate network tunneling tool used by millions of developers worldwide. Some antivirus software may flag it as a potential threat.',
    antivirusHint1: 'Windows Defender: Click "Allow" or "More info" → "Run anyway"',
    antivirusHint2: '360 Security: Add to trusted list',
    antivirusHint3: 'Other antivirus: Add ngrok to whitelist/exclusions',
  },
}

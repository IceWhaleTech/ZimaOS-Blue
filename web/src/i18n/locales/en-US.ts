...
export default {
  ...
  settings: {
    ...
    smallModel: {
      ...
      summarySuccessRate: 'Summary Success',
      summaryLatencyMs: 'Summary Latency',
      docExtractSuccessRate: 'Doc Extract Success',
      docExtractLatencyMs: 'Doc Extract Latency',
      fallbackTotal: 'Fallback Total',
      timeoutTotal: 'Timeout Total',
      latencyMs: 'Small-model Latency',
  ...
  apiProxy: {
    ...
    prunerSavings: 'Local IR saves ~47% tokens (code + docs).',

...
export default {
  ...
  tokenEconomy: {
    ...
    combined: 'Cache + Pruner combined',
    entries: 'entries',
    prunerActive: 'Active',
  ...
  apiProxy: {
    ...
    prunerDesc: 'Smart context pruning powered by IR scoring — removes low-relevance lines while preserving key code structures and semantics. Typically saves ~47% tokens on code and ~46% on documents with negligible impact on output quality.',
    ...
    backendLocalDesc: 'BM25-based IR scoring, no model download needed',
    backendOnnxDesc: 'Neural pruning with Qwen3-0.6B, higher accuracy',
    ...
    modelSavingsHint: 'Neural pruning for coding tasks — typically saves ~54% tokens with higher accuracy than local mode',
    downloadModel: 'Download Model',
    downloading: 'Downloading',

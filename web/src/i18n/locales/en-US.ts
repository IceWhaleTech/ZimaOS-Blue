...
export default {
  ...
  chat: {
    ...
    enhancedModeDesc: 'Enhanced mode: supports skills, tool calling, file operations, code execution, and more',
    enableEnhancedMode: 'Enable Enhanced Mode',
    enableEnhancedModeDesc: 'Enable enhanced mode for skills, tool calling, file operations, and more',
  ...
  agent: {
    mode: 'Agent Mode',
    modeDescription: 'Enable autonomous multi-step task execution',

...
export default {
  ...
  chat: {
    ...
    enhancedModeDesc: 'Optional enhancement is on: experience may be better. The built-in scheduler is currently in beta.',
    enableEnhancedMode: 'Optional CLI Boost',
    enableEnhancedModeDesc: 'Optional enhancement: turning it off does not affect core chat/agent usage; turning it on may improve experience. The built-in scheduler is currently in beta.',
  ...
  settings: {
    ...
    smallModel: {
      title: 'Small Model (LFM2.5-1.2B Q4KM)',
      description: 'Fixed model/runtime with IR-first fallback and DeepResearch degrade.',
      ready: 'Ready',
      downloading: 'Downloading',
      notReady: 'Not Ready',
      enabled: 'Enable Small Model Routing',
      enabledHint: 'Master switch for small-model enhancement paths.',
      runtime: 'Runtime',
      modelId: 'Model ID',
      noLLMDegrade: 'No LLM Degrade',
      unavailablePolicy: 'Unavailable Policy',
      shadowRatio: 'Shadow Ratio',
      summary: 'Summary / Compression',
      docExtract: 'Workflow Document Extraction',
      rerank: 'Skill Rerank',
      contextPrune: 'Context Pruning',
      shortQA: 'Short QA Routing',
      shadowOnly: 'Phase1: shadow only',
      toolDispatch: 'Tool Dispatch Routing',
      statsTitle: 'Routing & Fallback Stats',
      resetStats: 'Reset',
      shortQAAttempts: 'Short QA Attempts',
      shortQASuccessRate: 'Short QA Success',
      toolDispatchAttempts: 'Tool Dispatch Attempts',
      toolDispatchSuccessRate: 'Tool Dispatch Success',
      deepResearchFallbacks: 'DeepResearch Fallbacks',
      irTakeovers: 'IR Takeovers',
      autoRollbacks: 'Auto Rollbacks',
      shortQAShadow: 'Short QA Shadow',
      toolShadow: 'Tool Dispatch Shadow',
      ...
      downloadStarted: 'Small model download started',
      downloadFailed: 'Failed to start small model download',
      downloadCanceled: 'Small model download canceled',
      statsReset: 'Small-model stats reset',
      statsResetFailed: 'Failed to reset small-model stats',
  ...
  apiProxy: {
    ...
    prunerTitle: 'Context Pruner',
    prunerDesc: 'Removes low-relevance context while preserving key semantics, with negligible impact on output quality.',
    prunerSavings: 'Local IR saves ~47% tokens (code + docs). SWE-Pruner saves 54% tokens (code only).',
    prunerSwitch: 'Enable Pruner',
    prunerEnabled: 'Pruner enabled',
    prunerDisabled: 'Pruner disabled',
    prunerNotAvailable: 'Pruner backend not available',
    backend: 'Backend',
    backendLocal: 'Statistical Pruning',
    backendOnnx: 'Neural Pruning',
    backendHybrid: 'Hybrid (Local + ONNX)',
    backendLocalDesc: 'BM25-based IR scoring for code and documents, no model download needed',
    backendOnnxDesc: 'Qwen3-0.6B neural network for code only, higher accuracy',
    backendSwitched: 'Pruner backend switched',
    backendSwitchFailed: 'Backend switch failed',
    threshold: 'Threshold',
    ...
    routingDesc: 'Automatically route tasks to the best-priced model tier based on complexity',
    routingSwitch: 'Enable Smart Routing',
    routingEnabled: 'Smart routing enabled',
    routingDisabled: 'Smart routing disabled',
    routingRules: 'Routing Scenarios',
    routingRulesDesc: 'Toggle individual routing rules. Matched requests are routed to cheaper model tiers.',
    routingSavings: 'Est. savings per 1K req/day',
    routingSavingsMonth: '/mo',
    routingTraffic: 'Traffic',
    routingTarget: 'Target Tier',
    ruleSmallBody: 'Short Q&A',
    ruleSmallBodyDesc: 'Body < 3KB → Economy tier (saves ~97%)',
    ruleSimpleTools: 'Tool Calls',
    ruleSimpleToolsDesc: 'Simple tools (search/grep/weather) → Economy tier (saves ~98%)',
    ruleOrchestrator: 'Complex Reasoning',
    ruleOrchestratorDesc: '[ORCHESTRATOR] tag → Standard tier (saves ~97%)',
    ruleBackground: 'Background Tasks',
    ruleBackgroundDesc: 'Title gen/summary → Economy tier (saves ~98%)',
    ruleLongForm: 'Long Text Gen',
    ruleLongFormDesc: 'Large output, no matching rule (keeps original model)',
    ...
    tierEconomy: 'Economy',
    tierFree: 'Free',
    tierResolverEnabled: 'Smart routing active ({tiers} tiers, {models} models)',
    tierResolverDisabled: 'Smart routing unavailable (need 2+ price tiers)',
    ...
    smartToolsDesc: 'Use IR matching to send only relevant tools per query, reducing token usage',
  ...
  claudecode: {
    ...
    disabledWarningDesc: 'You are in standard mode, and chat/agent still work normally. Enhanced mode is optional and may improve experience; the built-in scheduler is currently in beta.',
    missingSkills: 'Some CLI-first skills may have lower compatibility in this mode',
    missingToolCalling: 'Auto model defaults to gpt-5.3-codex (instead of gpt-5.3-codex-spark)',
  ...
  providerPool: {
    ...
    verifyModelPlaceholder: 'Optional model ID (default: gpt-5.3-codex)',
  ...
  agent: {
    mode: 'Agent Mode',
    modeDescription: 'Enable continuous autonomous improvement loops until you turn it off',
    autoConfirm: 'Auto-Confirm',
    autoConfirmDescription: 'Skip confirmation for destructive actions (right-click agent button to toggle)',

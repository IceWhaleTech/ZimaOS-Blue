...
export default {
  ...
  chat: {
    ...
    // Security
    messageBlocked: 'Message blocked by security policy',
    ...
    enableClaudeCode: 'Enable Claude Code CLI',
    ...
    routingMode: {
      ...
      cloudOnlyDesc: 'Only cloud providers are configured',
      localOnlyDesc: 'Only local providers are configured',
    },
    // Provider selector
    addProvider: 'Add Provider',
    manageProviders: 'Manage Providers',
    autoSwitch: 'Auto Switch',
    autoSwitchDesc: 'Automatically switch to another provider if the current one fails',
    auto: 'Auto',
    // Provider status
  ...
  dashboard: {
    ...
    cards: {
      ...
      goroutinesChart: 'Goroutines Chart',
      heapChart: 'Heap Allocation',
      workerPool: 'Worker Pool',
      systemInfo: 'System Information',
      failoverStatus: 'Smart Failover',
    },
  },
  home: {
  ...
  a2ui: {
    ...
    palette: {
      ...
      desc: {
        ...
        list: 'Display items in a vertical list',
        table: 'Display data in rows and columns',
        chart: 'Visualize data with charts',
        form: 'Group form elements together',
        progress: 'Show progress or completion status',
        alert: 'Display important messages or notifications',
        code: 'Display formatted code with syntax highlighting',
        markdown: 'Render markdown formatted content',
        container: 'Generic container for grouping components',
        grid: 'Arrange components in a grid layout',
  ...
  channels: {
    ...
    dingtalkDesc: 'Connect with DingTalk Bot',
    dingtalkHint: 'Create a robot in DingTalk Developer Platform',
    dingtalkOpenChat: 'Open Bot Chat',
    qqDesc: 'Connect with QQ Bot',
    qqHint: 'Create a bot in QQ Open Platform (q.qq.com)',
    wechatDesc: 'Connect with WeChat Work Bot',
    wechatHint: 'Create an app in WeChat Work Admin Console',
    matrixDesc: 'Connect with Matrix protocol',
    matrixHint: 'Use your Matrix homeserver and bot account credentials',
  ...
  providerSettings: {
    ...
    saveConfigToSelectModel: 'Save your API configuration first, then you can select a model.',
    clickRefreshToLoadModels: 'Click refresh to load available models from the API.',
    noModelsAvailable: 'No models available. Please configure API key and click refresh.',
    // Validation messages
    ...
    botTokenRequired: 'Bot token is required',
    appTokenRequired: 'App token is required',
    phoneNumberRequired: 'Phone number is required',
    appPasswordRequired: 'App password is required',
    ...
    homeserverUrlRequired: 'Homeserver URL is required',
    userIdRequired: 'User ID is required',
    appKeyRequired: 'App Key is required',
    robotCodeRequired: 'Robot Code is required',
    configValidated: 'Configuration validated',
    iMessageReady: 'iMessage integration ready',
  ...
  'setup.providerDetection': {
    detecting: 'Detecting available providers...',
    error: 'Failed to detect providers',
    ollamaDetected: 'Detected at {endpoint}',
    ollamaNotDetected: 'Not detected',
    models: 'Models',
    apiKeyConfigured: 'API key configured',
    apiKeyNotConfigured: 'API key not configured',
    ccSwitchDetected: 'cc-switch detected',
    profiles: 'Profiles',
  },
  ...
  providerPool: {
    title: 'Provider Pool',
    subtitle: 'Manage LLM providers and API keys',
    ...
    routingModeAutoDesc: 'Automatically select the best provider based on priority',
    routingModeCloudDesc: 'Only use cloud providers',
    routingModeLocalDesc: 'Only use local providers',
    routingStrategy: 'Routing Strategy',
    strategyPriority: 'Priority',
    strategyCost: 'Lowest Cost',
    ...
    defaultPricingReadOnly: 'Default prices from built-in model definitions. Use custom pricing to override.',
    customPricing: 'Custom Pricing',
    customPricingDescription: 'Override pricing for specific models or providers',
    inputPrice: 'Input Price',
    outputPrice: 'Output Price',
    cachePrice: 'Cache Price',
    perMillionTokens: 'per 1M tokens',
    addModelPricing: 'Add Model Pricing',
    isDefault: 'Using default pricing',
    ...
    temperature: 'Temperature',
    temperatureHint: '0.0 - 2.0, controls randomness. Lower = more focused, higher = more creative.',
    maxTokensParam: 'Max Tokens',
    maxTokensHint: 'Maximum output tokens. Leave empty to use model default.',
    topP: 'Top P',
    topPHint: '0.0 - 1.0, nucleus sampling. Alternative to temperature.',
    default: 'Default',
    ...
    pricingConfig2: {
      ...
      description: 'Configure model pricing for cost calculation',
      default: 'Default Pricing',
      defaultDesc: 'Pricing used for unknown models',
      custom: 'Custom Pricing',
      customDesc: 'Override pricing for specific models',
      inputPrice: 'Input Price',
      outputPrice: 'Output Price',
      cachePrice: 'Cache Price',
      perMillionTokens: 'per 1M tokens',
      addCustom: 'Add Custom Pricing',
      setModelPricing: 'Set Model Pricing',
      modelId: 'Model ID',
      providerId: 'Provider ID',
      priceUnit: 'Prices are per 1M tokens in USD',
      noCustom: 'No custom pricing configured',
      removed: 'Model pricing removed',
      saved: 'Model pricing saved',
      defaultSaved: 'Default pricing saved',
      recalculate: 'Recalculate Costs',
      recalculating: 'Recalculating...',
      recalculateDesc: 'Recalculate historical costs with current pricing',
      oldCost: 'Old Cost',
      newCost: 'New Cost',

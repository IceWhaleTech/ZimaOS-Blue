...
export default {
  ...
  memoryService: {
    ...
    description: 'Browse and manage versioned memory entries with namespace isolation',
    namespace: 'Namespace',
    allNamespaces: 'All Namespaces',
    defaultNamespace: 'Default',
    defaultNamespaceOnly: 'Only the default namespace exists',
    statusAll: 'All',
    createNamespace: 'Create Namespace',
    deleteNamespace: 'Delete Namespace',
    confirmDeleteNamespace: 'Delete namespace "{name}" and all its entries?',
    namespaceName: 'Namespace Name',
    entries: 'Entries',
    noEntries: 'No memory entries yet',
    addEntry: 'Add Entry',
    addEntryTitle: 'Add Memory Entry',
    editEntry: 'Edit Entry',
    content: 'Content',
    contentPlaceholder: 'Enter memory content...',
    category: 'Category',
    categoryPlaceholder: 'e.g. preference, fact, context',
    tags: 'Tags',
    tagsPlaceholder: 'tag1, tag2, tag3',
    source: 'Source',
    sourcePlaceholder: 'e.g. user, agent, system',
    importance: 'Importance',
    ttl: 'TTL',
    ttlPlaceholder: 'e.g. 24h, 7d, 0 for no expiry',
    ...
    purgeSuccess: 'Purged {count} expired entries',
    stats: 'Stats',
    totalEntries: 'Total',

...
export default {
  ...
  providerPool: {
    ...
    allowedModelsHint: 'Select which models are available for this provider. If none selected, all models from the API will be available.',
    filtered: 'filtered',
  ...
  remoteAccess: {
    ...
    ngrokDomain: 'Custom Domain',
    ngrokDomainPlaceholder: 'e.g., myapp.ngrok-free.app',
    ngrokDomainHint: 'Optional: Use a free static domain from ngrok dashboard',
    // QR Code

...
export default {
  ...
  "harness": {
    "builder": {
      ...
      "description": "Use the full dataset, version, spec, and run workflow when you need precise control over every eval object.",
      "collapsed": "Advanced mode is folded away. Open it when you need to hand craft datasets, immutable versions, evaluation specs, or run metadata."
    },
    "datasets": {
      "eyebrow": "Reusable sources library",
      "title": "Datasets and versions",
      "description": "Each dataset can carry multiple frozen versions, letting specs rerun against the same manifest later. (UK)",
    ...
    "evalSpecs": {
      ...
      "description": "Specs capture one dataset snapshot plus the run kind, profile, and scoring setup needed to materialise repeatable runs.",
    ...
    "evalRun": {
      ...
      "reportDescription": "This preview joins the V3 evaluation run record with the underlying group report so you can inspect outcomes without leaving the console.",
    ...
    "evalRuns": {
      ...
      "description": "Run rows keep the V3 entry point visible while still linking back to the underlying group report and raw runtime trail.",
    ...
    "baseline": {
      ...
      "description": "Pin the selected evaluation run as a reusable baseline, then compare future candidates against it from the same console.",
    ...
    "compare": {
      ...
      "description": "Generate a persisted comparison report against a named baseline or another evaluation run from the same spec.",
    ...
    "group": {
      ...
      "retryable": "Able to retry",
      "outcomeScore": "Outcome mark",
      "executionScore": "Execution mark",
      "remediation": "Suggested fix",
      "scorecardInsights": "Calibration and proposal summary",
      "scorecardInsightsHint": "Harness shows scoring diagnostics here; proposal review still happens in Memory / Self-evolution.",
      "reviewProposals": "Review via Memory",
      "noScorecardInsights": "No calibration or proposal diagnostics were attached to the current scorecards yet.",
      "remediationMissingArtifact": "Attach the expected artefact path or label to the run, or align expected_artifacts with the actual output contract.",
      "remediationRequiredCheckMissing": "Emit a stable completion marker in events or results, or align required_checks with the observable success signal used here.",
      "remediationToolSelectionError": "Make the required tool available in this profile and steer planning so the run selects it explicitly.",
      "remediationForbiddenToolUsed": "Tighten tool policy, allowlists or prompt constraints so the forbidden tool cannot be selected for this case.",
      "remediationRunMissing": "Check scheduler persistence and run linking so the produced run is stored before scoring starts.",
      "remediationRunFailed": "Inspect the linked-run error and logs, fix the runtime failure, then retry the case.",
      "remediationRunCancelled": "Check what cancelled the run and stop approvals or user-input waits from terminating the attempt early.",
      "remediationRunAborted": "Inspect abort reasons from the driver or runtime and restore the execution path before trying again.",
      "remediationRunNotCompleted": "Reduce task scope or raise runtime budgets so the run can reach completed status and publish supporting evidence.",
      "remediationVerificationFailed": "Add stronger observable evidence or artefacts for success, or relax the contract if it is stricter than the intended outcome.",
      "remediationTimeout": "Shorten the task or increase timeout-related budgets so required steps can finish before scoring begins.",
      "remediationGeneric": "Inspect linked runs, checks and artefacts to align the runtime output with the declared contract.",
      "verificationChecks": "Validation checks",
      "expectedArtifacts": "Expected artefacts",
      "traceSummary": "Trace overview",
      "expectedValue": "Expected value",
      "actualValue": "Actual value",
      "eventCount": "Event tally",
      "artifactCount": "Artefact tally",
      "observedTools": "Observed tools used",
      "calibrationRef": "Calibration reference",
      "takeawayCandidateCount": "Takeaway suggestions",
      "proposalCount": "Proposal tally",
      "proposalIds": "Proposal references",
      "noProposalIds": "No review proposals linked",
      "artifacts": "Artefacts",
    ...
    "quickEval": {
      ...
      "conversationHint": "Generate draft cases by pairing each user message with the following assistant reply.",
      ...
      "datasetCreateFailed": "Quick eval could not create a dataset (UK)",
      "datasetVersionRequired": "Publish a dataset version before launching a quick eval. (UK)",
      "description": "Keep input minimal: choose cases, pick a preset, and Harness automatically creates the dataset version, evaluation spec, and run for you.",
      "draftCases": "Draft case set",
      "editManifest": "Edit cases JSON",
      "eyebrow": "Standard path",
      "launch": "Start quick evaluation",
      "launchHint": "Start from pasted cases, an earlier chat or an existing dataset. Harness fills in the object model in the background.",
      "minimalDescription": "Most runs only need the case source and a ready-made option. Everything else becomes an implementation detail rather than a required form.",
      ...
      "systemWillDoHint": "Create or reuse the dataset snapshot, choose a matching spec, attach the default baseline, and launch the run. (UK)",
      "title": "Quick evaluation",
      "untitledConversation": "Untitled chat",
      "useConversation": "Use chat",
      "versionCreateFailed": "Quick eval could not publish a dataset version (UK)"
    },
    "groups": {
      "controlPlaneDescription": "The raw group ledger still matters for retries, scorecards, linked runs and runtime debugging, so it stays visible alongside the higher-level V3 objects.",
      "subtitle": "Track eval groups, calibration traces, score breakdowns, and retries from one control-plane view.",
      "totalGroups": "Groups",
      "activeGroups": "Active",
      "totalItems": "Items",
  ...
  "chat": {
    ...
    "deepResearchCredibility": "Credibility",
    ...
    "taskLoop": "Ralph Loop",
    "deepResearchHoverDescription": "Launch a structured research workflow with retrieval, verification, and source-backed answers.",
    ...
    "ralphLoopHoverDescription": "Let the agent plan, use tools, apply changes, and keep iterating until the task lands cleanly.",
    ...
    "presetQuestions": {
      ...
      "examples": {
        "memoryBank": {
          ...
          "description": "Turn chats, emails, photos, and documents into a searchable life timeline you can revisit any time.",
          "prompt": "Organise my chat history, emails, photo metadata, and documents into a personal memory system. Extract time, place, people, events, and keywords, use OCR when needed, build a searchable timeline and topic index, and answer later questions with what happened, evidence, and chronology."
        },
        "readingCompanion": {
        ...
        "chipMarketBriefing": {
          ...
          "prompt": "Generate a pre-market briefing focused on NVDA, AMD, and the semiconductor chain. Summarise overnight price moves, important news, analyst views, market sentiment, and possible catalysts, then present what happened, why it matters, and what to watch today."
        },
        "morningBriefing": {
        ...
        "designAdaptation": {
          ...
          "description": "Take one design and quickly derive desktop, tablet, and mobile adaptation guidance plus a hand-off checklist.",
          "prompt": "Based on my design file or UI spec, produce a multi-device adaptation plan. Identify core layouts, reusable components, and key breakpoints, then output device-specific guidance, spec changes, and a hand-off checklist with major engineering risks."
        },
        "inspirationFeed": {
          ...
          "prompt": "Collect and organise strong references around the visual styles I prefer. Classify them by layout, colour, texture, mood, and interaction language, recommend adjacent references, and package each round into a moodboard and style brief I can use immediately."
        },
        "sentimentRadar": {
          ...
          "prompt": "Monitor community posts, social discussions, and video comments to identify sentiment, repeated complaints, expectations, and polarised viewpoints. Go beyond sentiment labels and summarise the real problems users care about, likely user segments, unmet needs, and product opportunities worth validating."
        },
        "dreamDialogue": {
        ...
        "aristotleDialogue": {
          ...
          "prompt": "Build a dialogue-ready knowledge container around Aristotle's works, reliable historical sources, and core ideas. Distil his concepts, values, argument style, and recurring question patterns, and answer me in his style while clearly separating original doctrine, reasonable inference, and modern extension."
        }
      }
    },
    ...
    "processTrace": {
      ...
      "details": {
        ...
        "networkInterruptWaiting": "The stream was interrupted after content had started. Waiting for the backend to recover.",
        ...
        "providerFailoverToolFollowUp": "Retrying the tool follow-up without the previously pinned provider.",
        "providerFailoverContinuationFollowUp": "Retrying the continuation follow-up without the previously pinned provider.",
    ...
    "skillAdvisorBody": "Use these keywords in the Skill Store if you want to find matching skills before you send.",
    "skillAdvisorLoadingBody": "Analysing this task to suggest skill keywords and capability tags.",
  ...
  "settings": {
    ...
    "smallModel": {
      ...
      "irMasterDesc": "Toggle all helper features below in one go.",
      ...
      "contextCompressionHint": "Compression still triggers automatically under context pressure; this toggle only controls whether the lightweight model gets first pass on that compression.",
      "contextCompressionMode": "Compression Mode",
      "contextCompressionModeHint": "Compression triggers automatically under context pressure. This only chooses which compression path to prefer, while current-turn intent still comes from the latest user message.",
      "contextCompressionModeAuto": "Auto: prefer lightweight-model compression, fall back to offline",
      ...
      "imageQAAttempts": "Image recognition acceleration Count",
      "imageQASuccessRate": "Image recognition acceleration Hit rate",
      "imageQALatencyMs": "Image recognition acceleration Latency",
      ...
      "irTakeovers": "Strategy take-overs",
  ...
  "plugins": {
    ...
    "skillUrlHint": "Supports GitHub raw/blob SKILL.md links, tree directory links, and direct URLs. Tree links install the full skill directory.",
  ...
  "memory": {
    ...
    "proposalsDescription": "Review AGENTS.md patch proposals generated from high-confidence research takeaways.",
    "proposalsDisabled": "Agent auto-reflect is disabled. Existing proposals can still be reviewed, but new ones will not be created.",
  ...
  "billing": {
    ...
    "reset": "Reset",
    "exportCSV": "Export CSV",
    "featureDisabled": "Billing is currently unavailable because provider usage tracking is not initialised.",
  ...
  "extensions": {
    ...
    "browse": {
      ...
      "toolGalleryHint": "Browse tools as cards, review what they do, and toggle them on or off quickly.",
  ...
  "security": {
    ...
    "authorizedDirectoriesOverviewDesc": "Manage workspace-external access and always-allowed exec/convert directories.",
    ...
    "directoryWhitelistDesc": "Allow file tools to access specific directories outside the workspace root.",
    ...
    "directoryWhitelistHint": "Use aliases such as {'@'}docs/... in tool calls. Paths must be absolute; aliases may contain letters, numbers, \"-\" and \"_\".",
    ...
    "sandboxStatus": {
      ...
      "description": "Review whether sandbox execution is enabled and inspect the runtime limits currently applied.",
    ...
    "scan": {
      ...
      "detailMessages": {
        ...
        "running_development": "Running in development mode. Ensure production settings before deployment.",
        "token_expiration_too_long_or_unset": "Token expiration is too long or not set. This increases risk of token theft.",
        "token_expiration_too_long": "Token expiration exceeds 8 hours. This increases risk of token theft.",
        "token_expiration_not_set": "Token expiration is not set. Check security.jwt.expiration in the loaded security configuration."
      },
      "categories": {
        "auth": "Authentication",
  ...
  "channels": {
    ...
    "groupAccessHint": "Open keeps current behaviour. Disabled blocks all group chats. Allowlist only accepts listed chats.",
    ...
    "groupAccessMentionHint": "Default behaviour is to reply in groups only when Blue is explicitly {'@'}mentioned.",
    ...
    "feishuHint": "Create a bot in Feishu Open Platform. Required: 1) Enable \"Long Connection\" for events; 2) Subscribe to \"im.message.receive_v1\" event; 3) Add \"im:message:send_as_bot\" permission; 4) Publish the app. Enable Session mode below to send new messages instead of replying to the original message.",
  ...
  "apiProxy": {
    ...
    "prunerDesc": "Controls the API proxy pruner for proxied /v1 requests. Blue chat may still skip pruning per request when context pressure is low.",
    ...
    "customMaskingEmpty": "No custom rules yet. Use the form below to cover internal IDs or proprietary secrets.",
    "customMaskingDesc": "Add regex-based rules for internal IDs, secrets, or business-specific fields.",
    ...
    "customMaskingHint": "Use a valid regular expression. {maskLabel} in replacement text keeps the localized mask label.",
  ...
  "skillStore": {
    ...
    "marketplace": {
      ...
      "hero": {
        ...
        "description": "Browse multi-source skills, inspect security posture, and only install what fits your workspace."
      },
      "badges": {
        "green": "Green shield",
        "yellow": "Warning",
      ...
      "results": {
        ...
        "syncHint": "The catalogue refreshes automatically once per day. Use Refresh sources when you need immediate updates.",
        "catalog": "Catalog",
      ...
      "detail": {
        ...
        "selectDescription": "Browse the aggregated catalog and inspect the security report before installing.",
  ...
  "speech": {
    ...
    "voiceWake": {
      "title": "Voice Wake",
      "description": "Keep listening for your wake words in the background, then send the spoken command to one fixed conversation.",
      "desktopNoteDescription": "Manage desktop wake words in Settings > Speech.",
      "enableTitle": "Background listening",
      "enableDescription": "Turn this on to keep listening for wake words in the background. Commands are only sent after a wake word is detected.",
      ...
      "messages": {
        ...
        "targetUnavailable": "The selected conversation is unavailable. Pick another conversation and save again.",
        ...
        "unsupported": "VoiceWake is only available when Blue is running locally on macOS (desktop app or interactive bluecli).",
      ...
      "localeHelp": "Optional. Enter a locale such as zh-CN or en-US. Leave this blank to follow the system default.",
      ...
      "targetDescription": "VoiceWake always sends commands to one fixed conversation in the background.",
  ...
  "resultCard": {
    ...
    "messages": {
      ...
      "screenshot_captured_interactive_elements_unavailable": "Screenshot captured (interactive elements unavailable)"
    },
    "copy": "Copy",
    "copied": "Copied!",
    "openLink": "Open",
  ...
  "tools": {
    ...
    "descriptions": {
      ...
      "research_run": "Run deep research. You can wait for the final report or get a job ID to check later.",
  ...
  "media": {
    ...
    "fallbackSourceLicenseUnverified": "Licence unverified",
    "generate": "Generate",

...
export default {
  ...
  chat: {
    ...
    modelFallback: {
      ...
      title: 'Switch to automatic routing and retry?',
      description:
        'The fixed model {model} is unavailable right now. Switch this chat back to automatic routing and retry your last request?',
  ...
  settings: {
    ...
    smallModel: {
      ...
      description:
        'Use the lightweight model first for simple tasks, with automatic fallback when it is unavailable.',
      ready: 'Available',
      downloading: 'Downloading',
      ...
      deepResearchFallbacks: 'Deep Research fall-backs',
    ...
    antigravity: {
      ...
      noModels: 'No quota information available',
        ...
        description: "Manage local ACP bridge commands plus remote A2A agent cards or RPC endpoints.",
        newAcp: "New ACP",
        newA2a: "New A2A",
        availableProfiles: "Available Profiles",
        editor: "Profile Editor",
        newProfile: "New profile",
        draftHint: "Choose a connection type, then fill the required fields below.",
        requiredName: "Give the profile a name",
        requiredAcpRoute: "Add the local command Blue should run",
        requiredA2aRoute: "Add an endpoint or agent card URL",
        requiredChecks: "Run verify and health checks before using it in chat",
        saveThenCheck: "Save first, then run verify and health checks",
        acpPlainTitle: "Local tools (ACP)",
        a2aPlainTitle: "Remote agents (A2A)",
        acpOverview: "Run a local CLI or bridge command on this machine.",
        a2aOverview: "Call a remote agent card or RPC endpoint over the network.",
        acpListHelp: "Use ACP when Blue should launch a local adapter or coding CLI on this device.",
        a2aListHelp: "Use A2A when Blue should call a remote service by endpoint or agent card URL.",
        acpSetupHelp: "Blue will start this command locally whenever the ACP adapter is needed.",
        a2aSetupHelp: "Blue will connect to this remote agent over HTTP using an endpoint or card URL.",
        duplicateReady: "Copied into a new editable draft.",
        ...
        endpointAndCard: "Endpoint + card",
        commandConfigured: "Command configured",
        cwd: "Working Directory",
        environment: "Environment Overrides",
        acpRouteHint: "Add the command and arguments Blue should launch locally.",
        endpoint: "Endpoint URL",
        cardUrl: "Agent Card URL",
        headers: "Request Headers",
        a2aRouteHint: "Add the remote endpoint or agent card that Blue should call.",
        builtinLocked: "Built-in profiles are read-only. Duplicate one to customise it.",
        ...
        duplicate: "Duplicate",
        builtinHelp: "Built-in profiles stay read-only so the seeded Claude, Codex, Gemini, and generic A2A entries remain stable.",
        connectionType: "Connection type",
        route: "Route",
        basicInfo: "Basic info",
        basicInfoHelp: "Use a clear name and short description so the profile is easy to spot later.",
        connectionDetails: "Connection details",
        acpConnectionHelp: "Tell Blue which local command it should run, plus any working directory or env overrides.",
        a2aConnectionHelp: "Tell Blue which remote endpoint or agent card it should call.",
        command: "Command and Args",
        commandHint: "Built-in ACP profiles use npx-based bridge launchers so Blue can start the adapter without assuming a separately installed binary.",
        accessControl: "Credentials and routing",
        accessControlHelp: "Only fill these fields when the target needs auth, provider wiring, or extra headers.",
        credentialSource: "Credential Source",
        authMethod: "Auth Method",
        advancedOptions: "Advanced options",
        advancedOptionsHelp: "IDs and raw metadata are usually only needed for imports or automation.",
        metadata: "Metadata",
        errors: {
  ...
  security: {
    ...
    directoryWhitelistHint:
      'Use aliases such as {\'@\'}docs/... in tool calls. Paths must be absolute; aliases may contain letters, numbers, "-" and "_".',
  ...
  providerPool: {
    ...
    customCompatibleProviderHint: 'Bring your own compatible endpoint and keep dynamic verify/probe support.',

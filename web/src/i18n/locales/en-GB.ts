...
export default mergeHarnessLocale('en-GB', {
  ...
  harness: {
    ...
    group: {
      ...
      ...harnessProviderRemediationGroup('en-GB'),
  ...
  chat: {
    ...
    taskFailedDuringClarification: 'Task failed during clarification',
    taskFailedDuringPlanning: 'Task failed during planning',
    taskFailedDuringConfirmation: 'Task failed during confirmation',
    taskFailedWhileRevisingPlan: 'Task failed while revising the plan',
    taskFailedWhileUpdatingRuntimeState: 'Task failed while updating runtime state',
    verificationFailedRecoveryFailed: 'Verification failed and recovery did not succeed',
    taskFailureGroundedVerificationFailed: 'grounded verification failed',
  ...
  settings: {
    ...
    externalAgents: {
      ...
      genericA2ATitle: 'Generic Remote A2A Agent',
  ...
  security: {
    ...
    scan: {
      ...
      items: {
        ...
        sandbox_enabled: {
          description: 'Check whether code execution is sandboxed',
        },
      },
    },
    threats: {
  ...
  channels: {
    ...
    wechatILinkManualAction: 'Manual Configuration',
    wechatILinkScanHint: 'Create a one-off setup session, reuse or auto-start remote access, then finish authorisation on your phone.',
    wechatILinkSetupCreating: 'Creating Session...',
    wechatILinkSetupCreateFailed: 'Failed to create setup session',
    wechatILinkSetupDescription: 'Scan the QR code on your phone, finish iLink authorisation, then Blue will write the configuration and enable the channel automatically.',
    ...
    wechatILinkSetupLoadFailed: 'Failed to load setup session',
    ...
    wechatILinkPairingPayloadPlaceholder: 'Paste the iLink pairing payload here, or leave it empty and fill API Base URL and Bot Token below.',
    ...
    wechatILinkDesc: 'Connect personal WeChat via iLink bot credentials',
    ...
    wechatILinkHint: 'Use scan-to-config as the primary path, or fill API Base URL and Bot Token manually as fallback',

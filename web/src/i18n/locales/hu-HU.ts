...
export default {
  ...
  browserMonitor: browserMonitorLocales['hu-HU'],
  theme: {
    styles: {
      title: 'Téma stílus',
  ...
  settings: {
    ...
    smallModel: {
      ...
      contextCompressionModeAuto:
        'Automatikus: a kis modell tömörítését részesíti előnyben, majd offline módra áll vissza',
      contextCompressionModeSmallModel: 'Először a kis modell',
      contextCompressionModeOffline: 'Determinisztikus offline',
      contextCompressionModeOff: 'Ki',
      ...
      contextCompressionSuccessRate: 'Kontextustömörítés találati aránya',
      contextCompressionLatencyMs: 'Kontextustömörítés késleltetése',
  ...
  security: {
    ...
    tabDescriptions: {
      ...
      controls:
        'Kezelje a megbízható könyvtárakat, a prompt-védelmi korlátokat és a maszkolási szabályokat.',
      network: 'Kezelje a TLS/HTTPS tanúsítványokat, a CORS-forrásokat és a hálózati kitettséget.',
      harness:

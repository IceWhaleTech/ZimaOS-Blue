...
var (
	datePatternRe             *regexp.Regexp
	delimiterSplitRe          *regexp.Regexp
	pureDigitsRe              *regexp.Regexp
	multiHyphenRe             *regexp.Regexp
	versionSuffixRe           *regexp.Regexp
	providerPrefixRe          *regexp.Regexp
	pricingMatcherRegexesOnce sync.Once
)

func ensurePricingMatcherRegexes() {
	pricingMatcherRegexesOnce.Do(func() {
...
var (
	...
	builtinModelFamilies   []ModelFamily
	builtinPricingDataOnce sync.Once
)

func ensureBuiltinPricingData() {
	builtinPricingDataOnce.Do(func() {
		BuiltinModelPricing = buildBuiltinModelPricing()
		builtinModelFamilies = buildBuiltinModelFamilies()
	})
}

// BuiltinModelPricing contains known model pricing (per 1M tokens, USD)
// Updated: 2026-02
func buildBuiltinModelPricing() map[string]*ModelPricing {
...
func buildBuiltinModelFamilies() []ModelFamily {
	return []ModelFamily{
		{
			Name:        "claude",

...
func (a *mgmtSettingsAdapter) GetAll(_ context.Context) (map[string]interface{}, error) {
	return map[string]interface{}{
		...
		"small_model_knowledge_fix_enabled":    a.handler.GetSmallModelKnowledgeFixEnabled(),

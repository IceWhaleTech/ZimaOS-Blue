...
func (a *mgmtSettingsAdapter) GetAll(_ context.Context) (map[string]interface{}, error) {
	return map[string]interface{}{
		...
		"skill_dynamic_exposure":               a.handler.GetSkillDynamicExposure(),
...
func (a *mgmtSettingsAdapter) Set(_ context.Context, key, value string) error {
	switch key {
	case "locale", "timezone", "smart_skill_selection", "skill_dynamic_exposure", "skill_selector_mode", "skill_rerank_enabled", "skill_rerank_model", "skill_rerank_onnx_enabled", "skill_rerank_onnx_auto_download", "skill_selector_confidence_threshold", "im_history_limit", "agent_mode", "agent_auto_reflect", "agent_auto_confirm", "small_model_enabled", "small_model_runtime", "small_model_id", "small_model_auto_download", "small_model_summary_enabled", "context_compression_mode", "small_model_context_compress_enabled", "small_model_doc_extract_enabled", "small_model_rerank_enabled", "small_model_context_prune_enabled", "small_model_context_prune_tool_allow", "small_model_context_prune_tool_deny", "small_model_media_intent_enabled", "offline_ir_fallback_enabled", "feature_intent_ir_enabled", "small_model_route_image_qa_enabled", "small_model_route_short_qa_enabled", "no_llm_degrade_mode", "small_model_unavailable_policy":
	default:
		return fmt.Errorf("unknown setting key: %s (valid: locale, timezone, smart_skill_selection, skill_dynamic_exposure, skill_selector_mode, skill_rerank_enabled, skill_rerank_model, skill_rerank_onnx_enabled, skill_rerank_onnx_auto_download, skill_selector_confidence_threshold, im_history_limit, agent_mode, agent_auto_reflect, agent_auto_confirm, small_model_enabled, small_model_runtime, small_model_id, small_model_auto_download, small_model_summary_enabled, context_compression_mode, small_model_context_compress_enabled, small_model_doc_extract_enabled, small_model_rerank_enabled, small_model_context_prune_enabled, small_model_context_prune_tool_allow, small_model_context_prune_tool_deny, small_model_media_intent_enabled, offline_ir_fallback_enabled, feature_intent_ir_enabled, small_model_route_image_qa_enabled, small_model_route_short_qa_enabled, no_llm_degrade_mode, small_model_unavailable_policy)", key)
	}

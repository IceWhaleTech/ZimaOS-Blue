...
func registerTranslationsPart1() {
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "產生的文件輸出無法通過驗證",
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "生成されたドキュメント出力を検証できませんでした",
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "생성된 문서 출력을 검증할 수 없습니다",
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "Die erzeugte Dokumentausgabe konnte nicht verifiziert werden",
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "La sortie du document généré n'a pas pu être vérifiée",
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "No se pudo verificar la salida del documento generado",
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "Impossibile verificare l'output del documento generato",
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "Não foi possível verificar a saída do documento gerado",
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "Не удалось проверить сгенерированный вывод документа",

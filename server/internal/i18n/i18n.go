...
const (
	...
	MsgNativeDocumentOutputVerificationFailed          = "error.native_document_output_verification_failed"
...
func buildBaseTranslations() map[Language]map[string]string {
	return map[Language]map[string]string{
		LangEnUS: {
			...
			MsgNativeDocumentOutputVerificationFailed:          "Generated document output could not be verified",
		...
		LangZhCN: {
			...
			MsgNativeDocumentOutputVerificationFailed:          "生成的文档输出未能通过校验",

...
func registerTranslationsPart3() {
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "Ieșirea documentului generat nu a putut fi verificată",
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "Nije moguće provjeriti izlaz generiranog dokumenta",
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "Δεν ήταν δυνατή η επαλήθευση της εξόδου του παραγόμενου εγγράφου",
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "No s'ha pogut verificar la sortida del document generat",
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "Níorbh fhéidir aschur na cáipéise ginte a fhíorú",
	...
	for k, v := range map[string]string{
		...
		MsgNativeDocumentOutputVerificationFailed: "സൃഷ്ടിച്ച ഡോക്യുമെന്റിന്റെ ഔട്ട്‌പുട്ട് പരിശോധിക്കാൻ കഴിഞ്ഞില്ല",

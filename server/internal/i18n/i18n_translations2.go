...
func registerTranslationsPart2() {
	...
	for k, v := range map[string]string{
		...
		MsgPathEscapesWorkspaceRoot:               "Ścieżka wychodzi poza katalog główny obszaru roboczego",
		MsgNativeDocumentOutputVerificationFailed: "Nie udało się zweryfikować wygenerowanego dokumentu",
	...
	for k, v := range map[string]string{
		...
		MsgPathEscapesWorkspaceRoot:               "Pad valt buiten de hoofdmap van de werkruimte",
		MsgNativeDocumentOutputVerificationFailed: "De gegenereerde documentuitvoer kon niet worden geverifieerd",
	...
	for k, v := range map[string]string{
		...
		MsgPathEscapesWorkspaceRoot:               "Sökvägen ligger utanför arbetsytans rotkatalog",
		MsgNativeDocumentOutputVerificationFailed: "Det gick inte att verifiera det genererade dokumentet",
	...
	for k, v := range map[string]string{
		...
		MsgPathEscapesWorkspaceRoot:               "Stien ligger uden for arbejdsområdets rodmappe",
		MsgNativeDocumentOutputVerificationFailed: "Det genererede dokumentoutput kunne ikke verificeres",
	...
	for k, v := range map[string]string{
		...
		MsgPathEscapesWorkspaceRoot:               "Stien er utenfor rotmappen til arbeidsområdet",
		MsgNativeDocumentOutputVerificationFailed: "Det genererte dokumentutdataet kunne ikke verifiseres",
	...
	for k, v := range map[string]string{
		...
		MsgPathEscapesWorkspaceRoot:               "Cesta je mimo kořenový adresář pracovního prostoru",
		MsgNativeDocumentOutputVerificationFailed: "Vygenerovaný výstup dokumentu se nepodařilo ověřit",
	...
	for k, v := range map[string]string{
		...
		MsgPathEscapesWorkspaceRoot:               "Cesta je mimo koreňový adresár pracovného priestoru",
		MsgNativeDocumentOutputVerificationFailed: "Vygenerovaný výstup dokumentu sa nepodarilo overiť",
	...
	for k, v := range map[string]string{
		...
		MsgPathEscapesWorkspaceRoot:               "Az elérési út a munkaterület gyökérkönyvtárán kívül van",
		MsgNativeDocumentOutputVerificationFailed: "A létrehozott dokumentumkimenet nem ellenőrizhető",

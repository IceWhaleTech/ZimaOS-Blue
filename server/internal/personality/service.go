...
func (s *Service) Create(name, description, systemPrompt string) (*Personality, error) {
...
func (s *Service) GetByID(id string) (*Personality, error) {
	return s.repo.GetByID(id)
}

// List retrieves all personalities
func (s *Service) List() ([]*Personality, error) {
	return s.repo.List()
}

// Update updates a personality
func (s *Service) Update(id, name, description, systemPrompt string) (*Personality, error) {
...
func (s *Service) AddTrait(id, key, value string, weight float64) (*Personality, error) {
...
func (s *Service) GetActive() (*Personality, error) {

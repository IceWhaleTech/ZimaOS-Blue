...
var defaultTokenPricingShared = []TokenPricing{
...
func DefaultTokenPricing() []TokenPricing {
	pricing := make([]TokenPricing, len(defaultTokenPricingShared))
	copy(pricing, defaultTokenPricingShared)
	return pricing
}
...
func NewTokenTracker() *TokenTracker {
	return &TokenTracker{
		...
		globalUsage: &TokenUsage{},
		pricing:     defaultTokenPricingShared,
	}
}

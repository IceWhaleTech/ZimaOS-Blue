...
func BuildKnowledgeBaseResearchGuidance() string {
	return "<knowledge_base_research>" +
		"<mission>Knowledge-base-grade research. Produce a reusable, evidence-backed knowledge asset rather than a quick answer.</mission>" +

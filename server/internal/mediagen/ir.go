...
var allLangKeywords = map[string]*langKeywords{
	"en": {
		...
		editVerbs:  []string{"edit", "change", "modify", "transform", "alter", "adjust", "fix", "retouch", "enhance", "upscale", "remove", "replace", "restyle"},
	...
	"zh": {
		...
		editVerbs:  []string{"编辑", "修改", "改", "变", "调整", "修复", "美化", "去除", "替换", "换"},
	...
	"ja": {
		...
		editVerbs:  []string{"編集", "変更", "修正", "加工", "調整", "変えて", "直して"},
	...
	"ko": {
		...
		editVerbs:  []string{"편집", "수정", "변경", "바꿔", "고쳐", "조정"},
	...
	"de": {
		...
		editVerbs:  []string{"bearbeiten", "ändern", "modifizieren", "anpassen", "korrigieren", "entfernen"},
	...
	"fr": {
		...
		editVerbs:  []string{"éditer", "modifier", "changer", "ajuster", "retoucher", "supprimer"},
	...
	"es": {
		...
		editVerbs:  []string{"editar", "modificar", "cambiar", "ajustar", "retocar", "eliminar"},
	...
	"pt": {
		...
		editVerbs:  []string{"editar", "modificar", "alterar", "ajustar", "retocar", "remover"},
		animVerbs:  []string{"animar", "mover", "dar vida"},
	...
	"it": {
		...
		editVerbs:  []string{"modificare", "cambiare", "editare", "aggiustare", "ritoccare", "rimuovere"},
	...
	"ru": {
		...
		editVerbs:  []string{"редактировать", "изменить", "поменять", "исправить", "убрать", "заменить"},

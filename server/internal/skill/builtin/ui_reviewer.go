	...
	return &UIReviewer{
		manifest: &skill.Manifest{
			...
			Inputs: []skill.Parameter{
				{Name: "action", Type: "string", Description: "Action: review_url (full review), review_image (VLM review of base64 image), check_accessibility (a11y check only)", Required: true},
				{Name: "url", Type: "string", Description: "Target URL (required for review_url, check_accessibility)"},

...
func (t *FileWriteBeginTool) Definition() ToolDefinition {
	return ToolDefinition{
		Name:        "write_begin",
		Description: "Starts a transactional multi-part file write. Use this when the output would exceed 500 lines or 64 KiB in a single call, then send repeated write_chunk calls and a final write_commit.",
		Icon:        "file-write",
...
func (t *FileWriteChunkTool) Definition() ToolDefinition {
	return ToolDefinition{
		Name:        "write_chunk",
		Description: "Appends one chunk to an active transactional file write session started by write_begin. Keep each chunk at or below 500 lines and 64 KiB.",
		Icon:        "file-write",
		Parameters: map[string]interface{}{
			"type": "object",
			"properties": map[string]interface{}{
				...
				"content": map[string]interface{}{
					"type":        "string",
					"description": "One chunk of text content to append. Keep each chunk at or below 500 lines and 64 KiB.",
				},
			},

	...
	return ToolDefinition{
		...
		Parameters: map[string]interface{}{
			...
			"properties": map[string]interface{}{
				...
				"nodes":        map[string]interface{}{"type": "array", "description": "Workflow nodes."},
				"connections":  map[string]interface{}{"type": "array", "description": "Workflow connections."},
				...
				"tags":         map[string]interface{}{"type": "array", "description": "Workflow tags."},

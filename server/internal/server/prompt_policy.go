...
func policyFingerprint(profile string) string {
	...
	case DefaultPromptPolicyProfile:
		return "tool_guidance_v7|initial_agent_turn_v1|toolless_nudge_v12|post_tool_nudge_v5|context_rules_v1"
	default:
		return "tool_guidance_v7|initial_agent_turn_v1|toolless_nudge_v12|post_tool_nudge_v5|context_rules_v1"
	}
}

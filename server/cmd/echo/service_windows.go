...
import (
	...
	"github.com/IceWhaleTech/ZimaOS-Echo/server/internal/service"
)
...
func (sc *ServiceCommands) Install() error {
	fmt.Println("Installing ZimaOS-Echo service...")
	...
	fmt.Println("  net start ZimaOS-Echo")
	fmt.Println("  or")
	fmt.Println("  sc start ZimaOS-Echo")
	fmt.Println("")
	fmt.Println("To view service status:")
	fmt.Println("  sc query ZimaOS-Echo")
	fmt.Println("")
	fmt.Println("To view logs:")
	fmt.Println("  Get-EventLog -LogName Application -Source ZimaOS-Echo")
...
func (sc *ServiceCommands) Uninstall() error {
	fmt.Println("Uninstalling ZimaOS-Echo service...")
...
func (sc *ServiceCommands) Start() error {
	fmt.Println("Starting ZimaOS-Echo service...")
...
func (sc *ServiceCommands) Stop() error {
	fmt.Println("Stopping ZimaOS-Echo service...")

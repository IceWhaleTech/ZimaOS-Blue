...
Do NOT use `wacli` for normal user chats; ZimaOS Blue routes WhatsApp conversations automatically.
...
- Group: `wacli send text --to "1807890-180789@g.us" --message "Running 5 min late."`

...
Bygget til modige udviklere, der vil **vibe eller håndbygge deres egne agenter**, er Blue **konstrueret til ydeevne**: skrevet i **Go** med et hukommelsesforbrug helt ned til 10 MB. Det kører på **enhver x86, Raspberry Pi, Windows, macOS** — overalt hvor du sætter strøm til.
...
> Benchmarket på macOS arm64, samme vært, bedste af 3 kørsler. Feb 2026.

### Ren Go, enhver enhed

100% Go, statisk binær. **Krydskompilerer til 5 mål** direkte fra kassen (![](https://raw.githubusercontent.com/drag-and-publish/operating-system-logos/master/src/16x16/LIN.png) amd64/arm64, ![](https://raw.githubusercontent.com/drag-and-publish/operating-system-logos/master/src/16x16/MAC.png) amd64/arm64, ![](https://raw.githubusercontent.com/drag-and-publish/operating-system-logos/master/src/16x16/WIN.png) amd64). Ingen Node-runtime, ingen Python, ingen containere påkrævet. Læg den på en NAS, en Raspberry Pi, en gammel x86-router eller en Mac — den kører bare. **Tilføj derefter din egen brugerflade, logik og agentfærdigheder** — én kodebase, alle platforme.
...
Vi minimerer standardkode, så du **fokuserer på det, der betyder noget**. Tro mod **ZimaOS' designfilosofi** leverer Blue:
...
### Mulighed 1: Download skrivebordsappen (macOS & Windows)

Hent den native applikation — ingen afhængigheder, ingen kompilering.

- **macOS**: [Download DMG](https://github.com/IceWhaleTech/ZimaOS-Blue/releases/latest)
- **Windows**: [Download installationsprogram](https://github.com/IceWhaleTech/ZimaOS-Blue/releases/latest)
...
| Integration | browser, homeassistant, cron, workflow, formfiller, tunnel, crawler |
...
| v0.10.27 | Kontekstbeskærer | BM25-scoring, segmentering, benchmarks | Done |

...
> Это русская версия README для ZimaOS Echo.

Полная документация доступна по адресу: https://echo.zimaos.com  
Остальная часть этого документа следует структуре основного README на английском языке. См. `../README.md` для получения самой актуальной и подробной информации.

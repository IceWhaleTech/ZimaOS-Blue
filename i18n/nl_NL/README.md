...
> Dit is de Nederlandse versie van de ZimaOS Echo README.

Voor de volledige documentatie, ga naar: https://echo.zimaos.com  
De rest van dit document volgt de structuur van de Engelse hoofd-README. Zie `../README.md` voor de meest recente en gedetailleerde informatie.

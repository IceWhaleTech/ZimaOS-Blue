...
**Heartbeat-bewaking**
```
Timer (30 min) → Lees HEARTBEAT.md → LLM-evaluatie → Verwijder HEARTBEAT_OK-token
  → Deduplicatie (FNV-hash, 24u TTL) → Kanaalwaarschuwing (Telegram/Slack/...)
  → Gebeurtenisstroom → UI-indicator
```

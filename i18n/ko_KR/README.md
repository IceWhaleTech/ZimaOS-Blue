...
**ZimaOS Blue**는 NAS 및 엣지 디바이스를 위한 경량·고성능 AI 에이전트 런타임입니다. Go로 빌드되어 제로 설정 배포, 세션 모니터링, 사용 분석을 갖춘 프로덕션 준비 플랫폼을 제공합니다.
...
ZimaOS Blue는 로컬 LLM 서비스를 포함한 여러 LLM 프로바이더를 지원합니다:

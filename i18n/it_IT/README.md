...
**ZimaOS Echo** è un runtime per agenti IA leggero e ad alte prestazioni pensato per NAS e dispositivi edge. Sviluppato in Go, offre una piattaforma pronta per la produzione con deploy a zero configurazione, monitoraggio delle sessioni e analisi dell’utilizzo.
...
ZimaOS Echo supporta più provider LLM, inclusi servizi LLM locali:

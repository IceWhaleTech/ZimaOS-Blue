...
> Questa è la versione italiana del README di ZimaOS Echo.

Per la documentazione completa, visita: https://echo.zimaos.com  
Il resto di questo documento segue la struttura del README principale in inglese. Consulta `../README.md` per le informazioni più aggiornate e dettagliate.

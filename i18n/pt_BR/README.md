...
> Esta é a versão em português (Brasil) do README do ZimaOS Echo.

Para a documentação completa, acesse: https://echo.zimaos.com  
O restante deste documento segue a estrutura do README principal em inglês. Consulte `../README.md` para obter as informações mais recentes e detalhadas.

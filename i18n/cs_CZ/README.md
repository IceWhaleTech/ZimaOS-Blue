...
<p align="center">
  <a href="https://github.com/IceWhaleTech/ZimaOS-Blue/actions"><img src="https://img.shields.io/github/actions/workflow/status/IceWhaleTech/ZimaOS-Blue/ci.yml?branch=main&style=badge" alt="Stav CI"></a>
  <a href="https://github.com/IceWhaleTech/ZimaOS-Blue/releases"><img src="https://img.shields.io/github/v/release/IceWhaleTech/ZimaOS-Blue?include_prereleases&style=badge" alt="Vydání na GitHubu"></a>
  <a href="../../LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=badge" alt="Licence MIT"></a>
</p>
...
Jsme inspirováni OpenClawem a věříme, že budoucnost osobních počítačů bude utvářena různorodými agenty umělé inteligence, kteří jsou první na místě.
...
- <img src="https://raw.githubusercontent.com/IceWhaleTech/ZimaOS/main/assets/20241126-153324.png" alt="ZimaOS" height="16" /> **ZimaOS**: [Spustit na ZimaOS](https://www.zimaspace.com/zimaos?utm_source=blue)
...
| Multimodální Native-Capability-First Runtime | Udržuje **hlas, OCR, PDF, úlohy prohlížeče, převod dokumentů, vyplňování strukturovaných formulářů, zpracování médií a lokální generování médií** na **nativních a místních cestách nejprve**, s **směrováním modelu pouze tehdy, když je to skutečně potřeba**. |

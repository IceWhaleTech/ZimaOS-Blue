...
**Monitor Heartbeat**
```
Timer (30 min) → Odczyt HEARTBEAT.md → Ocena LLM → Usunięcie tokena HEARTBEAT_OK
  → Deduplikacja (hash FNV, TTL 24h) → Alert kanału (Telegram/Slack/...)
  → Strumień zdarzeń → Wskaźnik UI
```

...
> **Poznámka:** Windows zostavenia vyžadujú [MinGW-w64](https://www.mingw-w64.org/) (gcc) a [CMake](https://cmake.org/) pre natívne C závislosti (espeak-ng, whisper.cpp, opus). Uistite sa, že `gcc` a `cmake` sú v `PATH`.

...
**ZimaOS Blue** là runtime agent AI nhẹ, hiệu năng cao dành cho NAS và thiết bị biên. Xây bằng Go, cung cấp nền tảng sẵn sàng production với triển khai không cấu hình, giám sát phiên và phân tích sử dụng.
...
ZimaOS Blue hỗ trợ nhiều nhà cung cấp LLM, bao gồm dịch vụ LLM local:

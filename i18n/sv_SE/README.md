...
> Detta är den svenska versionen av ZimaOS Echo README.

För fullständig dokumentation, besök: https://echo.zimaos.com  
Resten av detta dokument följer strukturen i den engelska huvud-README:n. Se `../README.md` för den senaste och mest detaljerade informationen.
